...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
  ...
  // Prevent hydration mismatch by ensuring it runs only on the client
  React.useEffect(() => {
    setMounted(true);
  }, []);
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-[#087cfb] text-white hover:bg-[#0462c9] hover:text-white focus:bg-[#0462c9] focus:text-white aria-selected:bg-[#087cfb] aria-selected:text-white",
